...
class ofCvBlobListener {
  public:
    ...
    virtual void blobOn( int x, int y, int bid, int order ) = 0;
    virtual void blobMoved( int x, int y, int bid, int order ) = 0;    
    virtual void blobOff( int x, int y, int bid, int order ) = 0;
